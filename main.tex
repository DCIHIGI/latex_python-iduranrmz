...
{1.0 cm}                        % margen superior
{18 cm}                      % anchura del texto
{25.5 cm}                    % altura del texto
{5 pt}                           % altura de los encabezados
{0.5 cm}                           % espacio entre el texto y los encabezados
{100 pt}                             % altura del pie de página
{0cm}                           % espacio entre el texto y el pie de página
